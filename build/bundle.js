var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	return {
    		c() {
    			h1 = element("h1");
    			h1.textContent = "My test app with Svelte";
    		},
    		m(target, anchor) {
    ...
    /* src/Counter.svelte generated by Svelte v3.38.1 */
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		...
    		m(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen(button, "click", /*buttonEvent*/ ctx[2]);
    				mounted = true;
    			}
    		},
    		p(ctx, [dirty]) {
    			if (dirty & /*name*/ 1) set_data(t0, /*name*/ ctx[0]);
    			if (dirty & /*score*/ 2) set_data(t2, /*score*/ ctx[1]);
    ...
    function instance($$self, $$props, $$invalidate) {
    	let { name = "Unnamed counter" } = $$props;
    	let score = 0;
    ...
    for(let i = 0; i < 5; i++) {
        new Counter({target: document.body, props: {name: i}});
    }
